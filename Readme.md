Before Node, JavaScript was limited for frontend i.e. JavaScript was meant to (and only ran) in the client's browsing without having access to the file system.</br></br>
